...
[![Deploy+on+Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https://github.com/ManishMusic/Manish_vc/tree/Py-Tgcalls(main)&envs=SESSION_NAME,BOT_TOKEN,BOT_USERNAME,BOT_NAME,ASSISTANT_NAME,API_ID,API_HASH,SUDO_USERS,DURATION_LIMIT)
