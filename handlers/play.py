...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> @AnkivectorMusicbot Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>Looks like @AnkivectorMusicbot  Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return                            
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> @AnkivectorMusicbot helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
        return     
    requested_by = message_.from_user.first_name
    chat_id=message_.chat.id
